        ...
        foreach ($postMetas as $meta) 
        {
            ...
            if( in_array($meta_clusters[0] , $followers) )
            {
                ...
                if($type == 'vedio')
                {
                    ...
                    $vedio_info['user_name'] = $user_name;
                    $vedio_info['post_id'] = $post_id;
                    $vedio_info['user_id']  = $meta_clusters[0];
                    $vedio_info['posted_date']  = $meta_clusters[1];
