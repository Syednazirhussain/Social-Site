  ...
  <nav class="px-nav px-nav-left">
        ...
        <ul class="px-nav-content">
            <li class="px-nav-item">
                <a href="javascript:void(0)"><i class="px-nav-icon  ion-ios-home"></i><span class="px-nav-label">Dashboard</span></a>
            </li>
            ...
            <li class="px-nav-item">
                <a href="javascript:void(0)">
                    <span class="px-nav-label"><i class="fa fa-cog"></i>&nbsp;Settings</span>
                </a>
            </li> 
        </ul>
    </nav>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            <img src="{{ asset('storage/user_images/'.Auth::user()->user_image) }}" alt="" class="px-navbar-image">
