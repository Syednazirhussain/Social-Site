...
<section id="main-slider" class="no-margin">
    <div class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active" style='background-image: url("{{ asset("/theme/images/slider/bg1.jpg") }}")'>
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
            ...
            <div class="item" style='background-image: url("{{ asset("/theme/images/slider/bg2.jpg")  }}")'>
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <div class="carousel-content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                <div class="recent-work-wrap">
                    <img class="img-responsive" src="{{ asset('/theme/images/portfolio/item-1.png') }}" alt="">
                    <div class="overlay">
                        <div class="recent-work-inner">
                            <a class="preview" href="{{ asset('/theme/images/portfolio/item-1.png') }}" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                <div class="recent-work-wrap">
                    <img class="img-responsive" src="{{ asset('/theme/images/portfolio/item-2.png') }}" alt="">
                    <div class="overlay">
                        <div class="recent-work-inner">
                            <a class="preview" href="{{ asset('/theme/images/portfolio/item-2.png') }}" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                <div class="recent-work-wrap">
                    <img class="img-responsive" src="{{ asset('/theme/images/portfolio/item-3.png') }}" alt="">
                    <div class="overlay">
                        <div class="recent-work-inner">
                            <a class="preview" href="{{ asset('/theme/images/portfolio/item-3.png') }}" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                <div class="recent-work-wrap">
                    <img class="img-responsive" src="{{ asset('/theme/images/portfolio/item-4.png') }}" alt="">
                    <div class="overlay">
                        <div class="recent-work-inner">
                            <a class="preview" href="{{ asset('/theme/images/portfolio/item-4.png') }}" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                <div class="recent-work-wrap">
                    <img class="img-responsive" src="{{ asset('/theme/images/portfolio/item-5.png') }}" alt="">
                    <div class="overlay">
                        <div class="recent-work-inner">
                            <a class="preview" href="{{ asset('/theme/images/portfolio/item-5.png') }}" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 single-work">
                <div class="recent-work-wrap">
                    <img class="img-responsive" src="{{ asset('/theme/images/portfolio/item-6.png') }}" alt="">
                    <div class="overlay">
                        <div class="recent-work-inner">
                            <a class="preview" href="{{ asset('/theme/images/portfolio/item-6.png') }}" rel="prettyPhoto"><i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
<section id="middle" class="skill-area" style='background-image: url("{{ asset("/theme/images/skill-bg.png") }}")'>
    <div class="container">
        <div class="row">
                        ...
                        <div class="parrent media-body">
                            <div class="tab-content">
                                <div class="tab-pane fade" id="tab1">
                                    <div class="media">
                                        <div class="pull-left">
                                            <img class="img-responsive" src="{{ asset('/theme/images/tab2.png') }}">
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="tab-pane fade active in text-right" id="tab2">
                                    <div class="video-box">
                                        <img src="{{ asset('/theme/images/tab-video-bg.png') }}" alt="video">
    ...
    <div class="container">
        ...
        <div class="testimonial-slider owl-carousel">
            <div class="single-slide">
                ...
                <div class="content">
                    <img src="{{ asset('/theme/images/review.png') }}" alt="">
            ...
            <ul>
                <li>
                    <a href="javascript:void(0)">
                        <img class="img-responsive fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms" src="{{ asset('/theme/images/partners/brand-1.png') }}">
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)">
                        <img class="img-responsive fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms" src="{{ asset('/theme/images/partners/brand-2.png') }}">
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)">
                        <img class="img-responsive fadeInDown" data-wow-duration="1000ms" data-wow-delay="900ms" src="{{ asset('/theme/images/partners/brand-3.png') }}">
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)">
                        <img class="img-responsive fadeInDown" data-wow-duration="1000ms" data-wow-delay="1200ms" src="{{ asset('/theme/images/partners/brand-4.png') }}">
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0)">
                        <img class="img-responsive fadeInDown" data-wow-duration="1000ms" data-wow-delay="1500ms" src="{{ asset('/theme/images/partners/brand-5.png') }}">
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-md-2">
                <a href="javascript:void(0)" class="footer-logo">
                    <img src="{{ asset('/theme/images/logo-black.png') }}" alt="logo">
                </a>
            </div>
            <div class="col-md-10">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="widget">
                            ...
                            <ul>
                                ...
                                <li><a href="javascript:void(0)">Ticket system</a></li>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="widget">
                            <h3>Our Partners</h3>
                            <ul>
                                <li><a href="javascript:void(0)">Adipisicing Elit</a></li>
                                <li><a href="javascript:void(0)">Eiusmod</a></li>
                                <li><a href="javascript:void(0)">Tempor</a></li>
                                <li><a href="javascript:void(0)">Veniam</a></li>
                                <li><a href="javascript:void(0)">Exercitation</a></li>
                                <li><a href="javascript:void(0)">Ullamco</a></li>
                                <li><a href="javascript:void(0)">Laboris</a></li>
                            </ul>
                        </div>
                    </div>
                    <!--/.col-md-3-->
